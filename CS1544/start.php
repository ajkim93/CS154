<?php
	$loginHistory = "???";
	if (!empty($_COOKIE["lastLogin"]) || isset($_COOKIE["lastLogin"]) || $_COOKIE["lastLogin"] != "") {
		$loginHistory = $_COOKIE["lastLogin"];
	}
...
<html>
	...
	<body>
		...
		<div id="main">
			...
			<p>
				<em>(last login from this computer was <?= $loginHistory ?>)</em>
			</p>
		</div>
